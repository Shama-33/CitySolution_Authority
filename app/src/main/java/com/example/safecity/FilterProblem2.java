...
public class FilterProblem2 extends Filter {
    private AdapterProblem2 adapter;
    private ArrayList<UserPhoto> filterlist;

    public FilterProblem2(AdapterProblem2 adapter, ArrayList<UserPhoto> filterlist) {
    ...
    protected void publishResults(CharSequence charSequence, FilterResults filterResults) {
        adapter.photoarray2=(ArrayList<UserPhoto>)filterResults.values;
